...
namespace MyNes.Core
{
    ...
    class Mapper115 : Board
    {
        ...
        private void SetupCHR()
        {
            if (!flag_c)
            {
                base.Switch02KCHR((chr_reg[0] >> 1) | chr_block, CHRArea.Area0000);
                base.Switch02KCHR((chr_reg[1] >> 1) | chr_block, CHRArea.Area0800);
                base.Switch01KCHR(chr_reg[2] | chr_block, CHRArea.Area1000);
                base.Switch01KCHR(chr_reg[3] | chr_block, CHRArea.Area1400);
                base.Switch01KCHR(chr_reg[4] | chr_block, CHRArea.Area1800);
                base.Switch01KCHR(chr_reg[5] | chr_block, CHRArea.Area1C00);
            }
            else
            {
                base.Switch02KCHR((chr_reg[0] >> 1) | chr_block, CHRArea.Area1000);
                base.Switch02KCHR((chr_reg[1] >> 1) | chr_block, CHRArea.Area1800);
                base.Switch01KCHR(chr_reg[2] | chr_block, CHRArea.Area0000);
                base.Switch01KCHR(chr_reg[3] | chr_block, CHRArea.Area0400);
                base.Switch01KCHR(chr_reg[4] | chr_block, CHRArea.Area0800);
                base.Switch01KCHR(chr_reg[5] | chr_block, CHRArea.Area0C00);
            }
        }
