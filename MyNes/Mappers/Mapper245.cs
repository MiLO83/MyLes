...
namespace MyNes.Core
{
    ...
    class Mapper245 : Board
    {
        ...
        internal override string Issues { get { return MNInterfaceLanguage.IssueMapper245; } }
        ...
        private void SetupPRG()
        {
            ...
            base.Switch08KPRG(prg_reg[flag_p ? 2 : 0] | prg_or, PRGArea.Area8000);
            base.Switch08KPRG(prg_reg[1] | prg_or, PRGArea.AreaA000);
            base.Switch08KPRG(prg_reg[flag_p ? 0 : 2] | prg_or, PRGArea.AreaC000);
            base.Switch08KPRG(prg_reg[3] | prg_or, PRGArea.AreaE000);
        }
