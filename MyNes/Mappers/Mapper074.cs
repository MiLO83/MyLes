...
namespace MyNes.Core
{
    ...
    class Mapper074 : Board
    {
        ...
        private void SetupCHR()
        {
            if (!flag_c)
            {
                Toggle02KCHR_RAM(chr_reg[0] != 0x8 && chr_reg[0] != 0x9, CHRArea.Area0000);
                base.Switch02KCHR(chr_reg[0] >> 1, 0x0000);

                Toggle02KCHR_RAM(chr_reg[1] != 0x8 && chr_reg[1] != 0x9, CHRArea.Area0800);
                base.Switch02KCHR(chr_reg[1] >> 1, CHRArea.Area0800);

                Toggle02KCHR_RAM(chr_reg[2] != 0x8 && chr_reg[2] != 0x9, CHRArea.Area1000);
                base.Switch01KCHR(chr_reg[2], CHRArea.Area1000);

                Toggle02KCHR_RAM(chr_reg[3] != 0x8 && chr_reg[3] != 0x9, CHRArea.Area1400);
                base.Switch01KCHR(chr_reg[3], CHRArea.Area1400);

                Toggle02KCHR_RAM(chr_reg[4] != 0x8 && chr_reg[4] != 0x9, CHRArea.Area1800);
                base.Switch01KCHR(chr_reg[4], CHRArea.Area1800);

                Toggle02KCHR_RAM(chr_reg[5] != 0x8 && chr_reg[5] != 0x9, CHRArea.Area1C00);
                base.Switch01KCHR(chr_reg[5], CHRArea.Area1C00);
            }
            else
            {
                Toggle02KCHR_RAM(chr_reg[0] != 0x8 && chr_reg[0] != 0x9, CHRArea.Area1000);
                base.Switch02KCHR(chr_reg[0] >> 1, CHRArea.Area1000);

                Toggle02KCHR_RAM(chr_reg[1] != 0x8 && chr_reg[1] != 0x9, CHRArea.Area1800);
                base.Switch02KCHR(chr_reg[1] >> 1, CHRArea.Area1800);

                Toggle02KCHR_RAM(chr_reg[2] != 0x8 && chr_reg[2] != 0x9, CHRArea.Area0000);
                base.Switch01KCHR(chr_reg[2], CHRArea.Area0000);

                Toggle02KCHR_RAM(chr_reg[3] != 0x8 && chr_reg[3] != 0x9, CHRArea.Area0400);
                base.Switch01KCHR(chr_reg[3], CHRArea.Area0400);

                Toggle02KCHR_RAM(chr_reg[4] != 0x8 && chr_reg[4] != 0x9, CHRArea.Area0800);
                base.Switch01KCHR(chr_reg[4], CHRArea.Area0800);

                Toggle02KCHR_RAM(chr_reg[5] != 0x8 && chr_reg[5] != 0x9, CHRArea.Area0C00);
