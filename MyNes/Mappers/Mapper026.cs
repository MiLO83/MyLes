    ...
    class Mapper026 : Board
    {
        ...
        internal override void WritePRG(ref ushort address, ref byte data)
        {
            switch (address)
            {
                ...
                case 0x9002: snd_1.Write1(ref data); break;
                case 0x9001: snd_1.Write2(ref data); break;
                case 0xA000: snd_2.Write0(ref data); break;
                case 0xA002: snd_2.Write1(ref data); break;
                case 0xA001: snd_2.Write2(ref data); break;
                case 0xB000: snd_3.Write0(ref data); break;
                case 0xB002: snd_3.Write1(ref data); break;
                case 0xB001: snd_3.Write2(ref data); break;
                case 0xB003:
                    {
                        switch ((data & 0xC) >> 2)
                        {
                ...
                case 0xD002: Switch01KCHR(data, CHRArea.Area0400); break;
                case 0xD001: Switch01KCHR(data, CHRArea.Area0800); break;
                case 0xD003: Switch01KCHR(data, CHRArea.Area0C00); break;
                case 0xE000: Switch01KCHR(data, CHRArea.Area1000); break;
                case 0xE002: Switch01KCHR(data, CHRArea.Area1400); break;
                case 0xE001: Switch01KCHR(data, CHRArea.Area1800); break;
        ...
        {
            // I think MMC 5 has the same mixer of nes with 2 channels silenced out.
            GetPrec(snd_1.output, 0xF, 0.14, out channels_out[0]);// Normalize Square 1 output from 0-15 into 0 - 14 % of the mix
            GetPrec(snd_2.output, 0xF, 0.14, out channels_out[1]);// Normalize Square 2 output from 0-15 into 0 - 14 % of the mix
            GetPrec(snd_3.output, 0xFF, 0.44, out channels_out[2]);// Normalize DMC-PCM output from 0-255 into 0 - 44 % of the mix

            return channels_out[0] + channels_out[1] + channels_out[2];// 0 - 1.0
        }
