...
namespace MyNes
{
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args != null)
            {
                foreach (string arg in args)
                {
                    if (arg == "-trace")
                    {
                        ...
                        string dir_path = Path.Combine(ApplicationFolder, "Logs");
                        Directory.CreateDirectory(dir_path);
                        string logPath = Path.Combine(dir_path, logFileName);
            ...
            {
                FormLanguage ff = new FormLanguage();
                ff.ShowDialog();

                do_settings_reset = ff.ResetAllSettings;
            }
            ...
            MyNesMain.Initialize(false, ApplicationFolder, WorkingFolder);
