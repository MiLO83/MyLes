...
namespace MyNes.Core
{
    public abstract class ISettings
    {
        ...
        public ISettings()
        {
            ...
            {
                if (attr.GetType() == typeof(SettingsInfoAttribute))
                {
                    SettingsInfoAttribute inf = (SettingsInfoAttribute)attr;
                    settingsFileName = inf.SettingsFileName;
                }
            }
            this.filePath = Path.Combine(MyNesMain.WorkingFolder, settingsFileName);
        }
        /// <summary>
        /// Initialize settings.
        /// </summary>
        public ISettings(string file_path)
        {
