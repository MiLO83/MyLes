...
namespace MyNes
{
    public partial class FormGettingStarted : Form
    {
        public FormGettingStarted()
        {
            ...
            radioButton_stereo.Checked = MyNesMain.RendererSettings.Audio_Channels == 2;
            radioButton_mono.Checked = MyNesMain.RendererSettings.Audio_Channels == 1;
            ...
            radioButton_audio_use_default_mixer.Checked = MyNesMain.RendererSettings.Audio_UseLookupTable;
            radioButton_audio_use_mynes_mixer.Checked = !MyNesMain.RendererSettings.Audio_UseLookupTable;
            ...
            switch (MyNesMain.RendererSettings.Audio_Frequency)
            {
                ...
                case 32000: comboBox_audio_freq.SelectedIndex = 2; break;
                case 44100: comboBox_audio_freq.SelectedIndex = 3; break;
                case 48000: comboBox_audio_freq.SelectedIndex = 4; break;
                case 88200: comboBox_audio_freq.SelectedIndex = 5; break;
                case 96000: comboBox_audio_freq.SelectedIndex = 6; break;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MyNesMain.RendererSettings.Audio_UseLookupTable = radioButton_audio_use_default_mixer.Checked;
            ...
            switch (comboBox_audio_freq.SelectedIndex)
            {
                ...
                case 2: MyNesMain.RendererSettings.Audio_Frequency = 32000; break;
                case 3: MyNesMain.RendererSettings.Audio_Frequency = 44100; break;
                case 4: MyNesMain.RendererSettings.Audio_Frequency = 48000; break;
                case 5: MyNesMain.RendererSettings.Audio_Frequency = 88200; break;
                case 6: MyNesMain.RendererSettings.Audio_Frequency = 96000; break;
            }
            ...
            MyNesMain.RendererSettings.Audio_Channels = radioButton_stereo.Checked ? 2 : 1;
            Close();
        }
        // SlimDX
        ...
        private void linkLabel4_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            try
            {
                System.Diagnostics.Process.Start("https://wiki.nesdev.com/w/index.php?title=APU_Mixer");
            }
            catch { }
        }
    }
