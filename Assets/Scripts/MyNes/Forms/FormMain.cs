    ...
    public partial class FormMain : Form
    {
        ...
        internal void LoadSettings()
        {
            ...
            for (int i = 0; i < Program.SupportedLanguages.Length / 3; i++)
            {
                ...
                item.Checked = Program.SupportedLanguages[i, 0] == Program.Settings.InterfaceLanguage;
                interfaceLanguageToolStripMenuItem.DropDownItems.Add(item);
            }
        }
        ...
        private void audioToolStripMenuItem_DropDownOpening(object sender, EventArgs e)
        {
            ...
            useMixerToolStripMenuItem.Checked = !MyNesMain.RendererSettings.Audio_UseLookupTable;
            ...
            enableFiltersToolStripMenuItem.Checked = MyNesMain.RendererSettings.Audio_FiltersEnabled;
            stereoToolStripMenuItem.Checked = MyNesMain.RendererSettings.Audio_Channels == 2;
            ...
            stereoNesToolStripMenuItem.Checked = MyNesMain.RendererSettings.Audio_StereoNes;
            stereoNesToolStripMenuItem.Enabled = MyNesMain.RendererSettings.Audio_Channels == 2;
            stereoNesSettingsToolStripMenuItem.Enabled = (MyNesMain.RendererSettings.Audio_Channels == 2) & MyNesMain.RendererSettings.Audio_StereoNes;
        }
        ...
        {
            MyNesMain.RendererSettings.Audio_UseLookupTable = !MyNesMain.RendererSettings.Audio_UseLookupTable;

            MyNesMain.VideoProvider.WriteInfoNotification(MyNesMain.RendererSettings.Audio_UseLookupTable ? Properties.Resources.Status53 : Properties.Resources.Status52, false);
        }
        ...
        private void frequencyToolStripMenuItem_DropDownOpening(object sender, EventArgs e)
        {
            ...
            ((ToolStripMenuItem)frequencyToolStripMenuItem.DropDownItems[2]).Checked = MyNesMain.RendererSettings.Audio_Frequency == 32000;
            ((ToolStripMenuItem)frequencyToolStripMenuItem.DropDownItems[3]).Checked = MyNesMain.RendererSettings.Audio_Frequency == 44100;
            ((ToolStripMenuItem)frequencyToolStripMenuItem.DropDownItems[4]).Checked = MyNesMain.RendererSettings.Audio_Frequency == 48000;
            ((ToolStripMenuItem)frequencyToolStripMenuItem.DropDownItems[5]).Checked = MyNesMain.RendererSettings.Audio_Frequency == 88200;
            ((ToolStripMenuItem)frequencyToolStripMenuItem.DropDownItems[6]).Checked = MyNesMain.RendererSettings.Audio_Frequency == 96000;
        }
        ...
        private void interfaceLanguageToolStripMenuItem_DropDownItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            int i = 0;
            int index = 0;
            foreach (ToolStripMenuItem item in interfaceLanguageToolStripMenuItem.DropDownItems)
            {
            ...
            Program.Settings.InterfaceLanguage = Program.SupportedLanguages[index, 0];

            MessageBox.Show(Properties.Resources.Message53, Properties.Resources.MessageCap9);
        }
        private void colorsAddToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormColorsAdd fmr = new FormColorsAdd();
            fmr.Show();
        }
        private void audioTestToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormAudioTest fmr = new FormAudioTest();
            fmr.Show();
        }

        private void enableFiltersToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MyNesMain.RendererSettings.Audio_FiltersEnabled = !MyNesMain.RendererSettings.Audio_FiltersEnabled;
            NesEmu.ApplyAudioSettings(false);
        }
        private void stereoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (MyNesMain.RendererSettings.Audio_Channels == 1)
                MyNesMain.RendererSettings.Audio_Channels = 2;
            else
                MyNesMain.RendererSettings.Audio_Channels = 1;

            ApplyAudioFreq();
        }
        private void stereoNesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            MyNesMain.RendererSettings.Audio_StereoNes = !MyNesMain.RendererSettings.Audio_StereoNes;
            ApplyAudioFreq();
        }

        private void stereoNesSettingsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            FormAudioChannelsPanConfig frm = new FormAudioChannelsPanConfig();
            frm.Show();
        }

        private void hzToolStripMenuItem4_Click(object sender, EventArgs e)
        {
            MyNesMain.RendererSettings.Audio_Frequency = 32000;
            ApplyAudioFreq();
        }

        private void hzToolStripMenuItem5_Click(object sender, EventArgs e)
        {
            MyNesMain.RendererSettings.Audio_Frequency = 88200;
            ApplyAudioFreq();
        }

        private void hzToolStripMenuItem6_Click(object sender, EventArgs e)
        {
            MyNesMain.RendererSettings.Audio_Frequency = 96000;
            ApplyAudioFreq();
        }
    }
}
