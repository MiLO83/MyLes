...
namespace MyNes.Core
{
    ...
    // TODO: mapper 119 is not working probably.
    class Mapper119 : Board
    {
        ...
        internal override string Issues { get { return MNInterfaceLanguage.IssueMapper119; } }
        ...
        private void SetupCHR()
        {
            if (!flag_c)
            {
                base.Toggle02KCHR_RAM((chr_reg[0] & 0x40) != 0, CHRArea.Area0000);
                base.Switch02KCHR(chr_reg[0] >> 1, CHRArea.Area0000);
                base.Toggle02KCHR_RAM((chr_reg[1] & 0x40) != 0, CHRArea.Area0800);
                base.Switch02KCHR(chr_reg[1] >> 1, CHRArea.Area0800);
                base.Toggle02KCHR_RAM((chr_reg[2] & 0x40) != 0, CHRArea.Area1000);
                base.Switch01KCHR(chr_reg[2], CHRArea.Area1000);
                base.Toggle02KCHR_RAM((chr_reg[3] & 0x40) != 0, CHRArea.Area1400);
                base.Switch01KCHR(chr_reg[3], CHRArea.Area1400);
                base.Toggle02KCHR_RAM((chr_reg[4] & 0x40) != 0, CHRArea.Area1800);
                base.Switch01KCHR(chr_reg[4], CHRArea.Area1800);
                base.Toggle02KCHR_RAM((chr_reg[5] & 0x40) != 0, CHRArea.Area1C00);
                base.Switch01KCHR(chr_reg[5], CHRArea.Area1C00);
            }
            else
            {
                base.Toggle02KCHR_RAM((chr_reg[0] & 0x40) != 0, CHRArea.Area1000);
                base.Switch02KCHR(chr_reg[0] >> 1, CHRArea.Area1000);
                base.Toggle02KCHR_RAM((chr_reg[1] & 0x40) != 0, CHRArea.Area1800);
                base.Switch02KCHR(chr_reg[1] >> 1, CHRArea.Area1800);
                base.Toggle02KCHR_RAM((chr_reg[2] & 0x40) != 0, CHRArea.Area0000);
                base.Switch01KCHR(chr_reg[2], CHRArea.Area0000);
                base.Toggle02KCHR_RAM((chr_reg[3] & 0x40) != 0, CHRArea.Area0400);
                base.Switch01KCHR(chr_reg[3], CHRArea.Area0400);
                base.Toggle02KCHR_RAM((chr_reg[4] & 0x40) != 0, CHRArea.Area0800);
                base.Switch01KCHR(chr_reg[4], CHRArea.Area0800);
                base.Toggle02KCHR_RAM((chr_reg[5] & 0x40) != 0, CHRArea.Area0C00);
