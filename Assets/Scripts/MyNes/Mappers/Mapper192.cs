...
namespace MyNes.Core
{
    ...
    //TODO:  Mapper 192: Not tested yet
    class Mapper192 : Board
    {
        ...
        private void SetupCHR()
        {
            if (!flag_c)
            {
                ...
                base.Switch02KCHR(isRam ? (chr_reg[0] - 0x8) >> 1 : chr_reg[0] >> 1, 0x0000);
                isRam = chr_reg[1] >= 0x8 && chr_reg[1] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area0000);
                base.Switch02KCHR(isRam ? (chr_reg[1] - 0x8) >> 1 : chr_reg[1] >> 1, CHRArea.Area0800);
                isRam = chr_reg[2] >= 0x8 && chr_reg[2] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area1000);
                base.Switch01KCHR(isRam ? (chr_reg[2] - 0x8) : chr_reg[2], CHRArea.Area1000);
                isRam = chr_reg[3] >= 0x8 && chr_reg[3] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area1400);
                base.Switch01KCHR(isRam ? (chr_reg[3] - 0x8) : chr_reg[3], CHRArea.Area1400);
                isRam = chr_reg[4] >= 0x8 && chr_reg[4] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area1800);
                base.Switch01KCHR(isRam ? (chr_reg[4] - 0x8) : chr_reg[4], CHRArea.Area1800);
                isRam = chr_reg[5] >= 0x8 && chr_reg[5] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area1C00);
                base.Switch01KCHR(isRam ? (chr_reg[5] - 0x8) : chr_reg[5], CHRArea.Area1C00);
            }
            else
            {
                isRam = chr_reg[0] >= 0x8 && chr_reg[0] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area1000);
                base.Switch02KCHR(isRam ? (chr_reg[0] - 0x8) >> 1 : chr_reg[0] >> 1, CHRArea.Area1000);
                isRam = chr_reg[1] >= 0x8 && chr_reg[1] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area1800);
                base.Switch02KCHR(isRam ? (chr_reg[1] - 0x8) >> 1 : chr_reg[1] >> 1, CHRArea.Area1800);
                isRam = chr_reg[2] >= 0x8 && chr_reg[2] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area0000);
                base.Switch01KCHR(isRam ? (chr_reg[2] - 0x8) : chr_reg[2], CHRArea.Area0000);
                isRam = chr_reg[3] >= 0x8 && chr_reg[3] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area0400);
                base.Switch01KCHR(isRam ? (chr_reg[3] - 0x8) : chr_reg[3], CHRArea.Area0400);
                isRam = chr_reg[4] >= 0x8 && chr_reg[4] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area0800);
                base.Switch01KCHR(isRam ? (chr_reg[4] - 0x8) : chr_reg[4], CHRArea.Area0800);
                isRam = chr_reg[5] >= 0x8 && chr_reg[5] <= 0xB; Toggle02KCHR_RAM(isRam, CHRArea.Area0C00);
                base.Switch01KCHR(isRam ? (chr_reg[5] - 0x8) : chr_reg[5], CHRArea.Area0C00);
            }
        }
