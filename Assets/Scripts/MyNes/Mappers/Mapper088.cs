                ...
                case 0x8001:
                    {
                        switch (address_8001)
                        {
                            case 0x0: Switch02KCHR((data & 0x3F) >> 1, CHRArea.Area0000); break;
                            case 0x1: Switch02KCHR((data & 0x3F) >> 1, CHRArea.Area0800); break;
                            case 0x2: Switch01KCHR(data | 0x40, CHRArea.Area1000); break;
                            case 0x3: Switch01KCHR(data | 0x40, CHRArea.Area1400); break;
                            case 0x4: Switch01KCHR(data | 0x40, CHRArea.Area1800); break;
                            case 0x5: Switch01KCHR(data | 0x40, CHRArea.Area1C00); break;
                            case 0x6: Switch08KPRG(data, PRGArea.Area8000); break;
